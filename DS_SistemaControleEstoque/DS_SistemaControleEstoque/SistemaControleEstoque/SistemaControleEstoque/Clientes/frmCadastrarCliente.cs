...
namespace SistemaControleEstoque.Clientes
{
    public partial class frmCadastrarCliente : Form
    {
        ...
        private void txtRG_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            try
            {
                ...
                if (dataReader.HasRows)
                {
                    ...
                    toolStripStatusLlblMsg.Text = "Clente já cadastrado. Digite outro RG e pressione <ENTER> novamente.";
                }
                else
                {
        ...
        private void btnCadastrar_Click(object sender, EventArgs e)
        {
            ...
            {
                toolStripStatusLlblMsg.Text = "Todos os campos devem ser preenchidos para que o cliente seja cadastrado.";
                return;
            }

            try
            {
                string query = "INSERT INTO tb_cliente (cli_rg, cli_nome, cli_endereco, cli_cidade, cli_uf, cli_fone) "+
                    "VALUES (@rg, @nome, @endereco, @cidade, @uf, @fone);";
                MySqlCommand comando = new MySqlCommand(query, conexao);
                comando.Parameters.AddWithValue("@rg", txtRG.Text);
